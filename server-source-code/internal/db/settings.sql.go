...
const updateLicenseSettings = `-- name: UpdateLicenseSettings :exec
UPDATE settings SET
    updated_at = NOW(),
    license_max_hosts = $1,
    license_enforce = $2,
...
type UpdateLicenseSettingsParams struct {
...
func (q *Queries) UpdateLicenseSettings(ctx context.Context, arg UpdateLicenseSettingsParams) error {
	_, err := q.db.Exec(ctx, updateLicenseSettings,
		arg.LicenseMaxHosts,
		arg.LicenseEnforce,
		arg.LicensePackage,
		arg.ID,
