...
SELECT h.id, h.machine_id, h.friendly_name, h.hostname, h.ip, h.os_type, h.os_version,
    ...
    h.needs_reboot, h.reboot_reason, h.allow_reboot, h.fork_pkg_broken, h.fork_pkg_broken_detail, h.system_uptime, h.docker_enabled, h.compliance_enabled, h.compliance_on_demand_only,
    h.last_update,
